...
/// EDIT HERE ///
const API_KEY = "uCgeLayPux25pDyDDLq85mkTGgUytO08pCznB87hx9s="
const API_SECRET = "rds3+QQ1/sbbACzwxjdKdII3wwbwQNHy8nMRh7ws14s="
/////////////
...
const init = async (client) => {
    try {
        ...
        console.log(getNowFormatDate(), "The order failed, the order is being placed again..");
        await delay(10000);
        ...
        console.log(getNowFormatDate(), `The order failed, the order is being placed again... (${e.message})`);
        console.log("=======================")
